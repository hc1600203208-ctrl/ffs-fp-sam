...
int main(int argc, char** argv) {
    ...
    std::string engine_path = "/workspaces/data/defomstereo_vits_rvc_disparity_iter12_bf16.engine";
    std::string left_image_path = "/workspaces/data/1_left_image.png";
    std::string right_image_path = "/workspaces/data/1_right_image.png";
    std::string output_path = "/workspaces/data/1_disparity.png";
    ...
    DefomStereoEstimator estimator(engine_path, target_height, target_width);
