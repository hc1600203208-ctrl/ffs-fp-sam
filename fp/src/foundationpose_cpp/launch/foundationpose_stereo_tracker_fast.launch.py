...
def generate_launch_description():
    ...
    dino_onnx = LaunchConfiguration("dino_onnx")
    ...
    launch_args = [
        ...
        DeclareLaunchArgument(
            "dino_engine",
            default_value="/home/bit/ffs+fp+sam/sam/engines/grounding_dino_fixed_golden_object.engine",
        ),
        DeclareLaunchArgument("dino_onnx", default_value=""),
        DeclareLaunchArgument(
            "sam_encoder_engine",
            default_value="/home/bit/ffs+fp+sam/sam/engines/sam_image_encoder.engine",
        ),
        DeclareLaunchArgument(
            "sam_decoder_engine",
            default_value="/home/bit/ffs+fp+sam/sam/engines/sam_mask_decoder.engine",
        ),
